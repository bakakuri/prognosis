...
function normalizeTeam(t) {
  if (!t) return { providerId: '0', name: 'TBD', code: null, country: null, logo: null, venue: { name: null, city: null } };
  return {
    providerId: String(t.id || '0'),
    name: t.name || t.shortName || `Team_${t.id}`,
    code: t.tla || null,
...
module.exports = {
  getFixtures, getLiveFixtures, getFixtureById,
  getStandings, getTeamsByLeague, getInjuries,
  getStatus, getProviderHealth,
};
